 ...
 * LCD
 */
#define MIFPCON_REG  	    (*((volatile unsigned int *)0x7410800C))
#define SPCON_REG        	(*((volatile unsigned int *)0x7F0081A0))
#define VIDCON0_REG      	(*((volatile unsigned int *)0x77100000))
#define VIDCON1_REG      	(*((volatile unsigned int *)0x77100004))
#define VIDTCON0_REG     	(*((volatile unsigned int *)0x77100010))
#define VIDTCON1_REG     	(*((volatile unsigned int *)0x77100014))
#define VIDTCON2_REG     	(*((volatile unsigned int *)0x77100018))
#define WINCON0_REG      	(*((volatile unsigned int *)0x77100020))
#define VIDOSD0A_REG      	(*((volatile unsigned int *)0x77100040))
#define VIDOSD0B_REG      	(*((volatile unsigned int *)0x77100044))
#define VIDOSD0C_REG      	(*((volatile unsigned int *)0x77100048))
#define VIDW00ADD0B0_REG    (*((volatile unsigned int *)0x771000A0))
#define VIDW00ADD1B0_REG    (*((volatile unsigned int *)0x771000D0))
#define VIDW00ADD2_REG      (*((volatile unsigned int *)0x77100100))
#define DITHMODE_REG        (*((volatile unsigned int *)0x77100170))
#define WIN0_PALENTRY_BASE_REG  (*((volatile unsigned int *)0x77100400))
#define WPALCON_REG         (*((volatile unsigned int *)0x771001A0))
