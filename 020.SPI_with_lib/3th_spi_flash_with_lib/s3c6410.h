...
#define P1MEMCCMD_REG		(*((volatile unsigned int *)0x7e001004))
#define P1REFRESH_REG		(*((volatile unsigned int *)0x7e001010))
#define P1CASLAT_REG		(*((volatile unsigned int *)0x7e001014))
#define MEM_SYS_CFG_REG		(*((volatile unsigned int *)0x7e00f120))
#define P1MEMCFG_REG		(*((volatile unsigned int *)0x7e00100c))
#define P1T_DQSS_REG		(*((volatile unsigned int *)0x7e001018))
#define P1T_MRD_REG			(*((volatile unsigned int *)0x7e00101c))
#define P1T_RAS_REG			(*((volatile unsigned int *)0x7e001020))
#define P1T_RC_REG			(*((volatile unsigned int *)0x7e001024))
#define P1T_RCD_REG			(*((volatile unsigned int *)0x7e001028))
#define P1T_RFC_REG			(*((volatile unsigned int *)0x7e00102c))
#define P1T_RP_REG			(*((volatile unsigned int *)0x7e001030))
#define P1T_RRD_REG			(*((volatile unsigned int *)0x7e001034))
#define P1T_WR_REG			(*((volatile unsigned int *)0x7e001038))
#define P1T_WTR_REG			(*((volatile unsigned int *)0x7e00103c))
#define P1T_XP_REG			(*((volatile unsigned int *)0x7e001040))
#define P1T_XSR_REG			(*((volatile unsigned int *)0x7e001044))
#define P1T_ESR_REG			(*((volatile unsigned int *)0x7e001048))
#define P1MEMCFG2_REG		(*((volatile unsigned int *)0X7e00104c))
#define P1_chip_0_cfg_REG	(*((volatile unsigned int *)0x7e001200))
#define P1MEMSTAT_REG		(*((volatile unsigned int *)0x7e001000))
#define P1MEMCCMD_REG		(*((volatile unsigned int *)0x7e001004))
#define P1DIRECTCMD_REG		(*((volatile unsigned int *)0x7e001008))
...
#define NFCMMD_REG				__REG_BYTE(ELFIN_NAND_BASE+NFCMMD_OFFSET)
#define NFADDR_REG           	__REG_BYTE(ELFIN_NAND_BASE+NFADDR_OFFSET)
#define NFDATA_REG          	__REG_BYTE(ELFIN_NAND_BASE+NFDATA_OFFSET)
...
#define NFSTAT_REG           	__REG_BYTE(ELFIN_NAND_BASE+NFSTAT_OFFSET)
 ...
 * LCD
 */
#define MIFPCON_REG  	    (*((volatile unsigned long *)0x7410800C))
#define SPCON_REG        	(*((volatile unsigned long *)0x7F0081A0))
#define VIDCON0_REG      	(*((volatile unsigned long *)0x77100000))
#define VIDCON1_REG      	(*((volatile unsigned long *)0x77100004))
#define VIDTCON0_REG     	(*((volatile unsigned long *)0x77100010))
#define VIDTCON1_REG     	(*((volatile unsigned long *)0x77100014))
#define VIDTCON2_REG     	(*((volatile unsigned long *)0x77100018))
#define WINCON0_REG      	(*((volatile unsigned long *)0x77100020))
#define VIDOSD0A_REG      	(*((volatile unsigned long *)0x77100040))
#define VIDOSD0B_REG      	(*((volatile unsigned long *)0x77100044))
#define VIDOSD0C_REG      	(*((volatile unsigned long *)0x77100048))
#define VIDW00ADD0B0_REG    (*((volatile unsigned long *)0x771000A0))
#define VIDW00ADD1B0_REG    (*((volatile unsigned long *)0x771000D0))
#define VIDW00ADD2_REG      (*((volatile unsigned long *)0x77100100))
#define DITHMODE_REG        (*((volatile unsigned long *)0x77100170))
...
#define VIC0INTENABLE_REG	 (*(unsigned int volatile *)0x71200010) 
#define VIC1INTENABLE_REG	 (*(unsigned int volatile *)0x71300010)  

#define VIC0INTSELECT_REG	 (*(unsigned int volatile *)0x7120000C)
#define VIC1INTSELECT_REG	 (*(unsigned int volatile *)0x7130000C)

#define VIC0VECTADDR_REG	  (*(unsigned int volatile *)0x71200100)
#define VIC1VECTADDR_REG	  (*(unsigned int volatile *)0x71300100)

#define VIC0IRQSTATUS_REG	 (*(unsigned int volatile *)0x71200000) 
#define VIC1IRQSTATUS_REG	 (*(unsigned int volatile *)0x71300000)

#define VIC0ADDRESS_REG      (*(unsigned int volatile *)0x71200F00)  
#define VIC1ADDRESS_REG	     (*(unsigned int volatile *)0x71300F00)

#define VIC0SOFTINT_REG      (*(unsigned int volatile *)0x71200018)

#define VIC0INTENCLEAR_REG		 (*(unsigned int volatile *)0x71200014)  
#define VIC1INTENCLEAR_REG		 (*(unsigned int volatile *)0x71300014)


// extern interrupt  
#define EINT0CON0_REG 			(*(unsigned int volatile *)0x7F008900)  
#define EINT0MASK_REG			 (*(unsigned int volatile *)0x7F008920)  
#define EINT0PEND_REG 			(*(unsigned int volatile *)0x7F008924)  
#define EINT0FLTCON0_REG 		(*(unsigned int volatile *)0x7F008910) 
...
/* ADC */
#define ADCCON_REG      __REG(0x7E00B000)
#define ADCTSC_REG      __REG(0x7E00B004)
#define ADCDLY_REG      __REG(0x7E00B008)
#define ADCDAT0_REG     __REG(0x7E00B00c)
#define ADCDAT1_REG     __REG(0x7E00B010)
#define ADCUPDN_REG     __REG(0x7E00B014)
#define ADCCLRINT_REG   __REG(0x7E00B018)
#define ADCCLRWK_REG    __REG(0x7E00B020)

#define VIC1VECTADDR30_REG      (*((volatile unsigned int *)0x71300178))
#define VIC1VECTADDR31_REG      (*((volatile unsigned int *)0x7130017c))

/* IIC */
#define IICCON_REG      __REG(0x7F004000)
#define IICSTAT_REG     __REG(0x7F004004)
#define IICADD_REG      __REG(0x7F004008)
#define IICDS_REG       __REG(0x7F00400C)
#define IICLC_REG       __REG(0x7F004010)


/* SPI */
#define CH0_CFG_REG       __REG(0x7F00B000)
#define CH1_CFG_REG       __REG(0x7F00C000)

#define Clk0_CFG_REG      __REG(0x7F00B004)
#define Clk1_CFG_REG      __REG(0x7F00C004)

#define MODE0_CFG_REG      __REG(0x7F00B008)
#define MODE1_CFG_REG      __REG(0x7F00C008)

#define SLAVE0_SLECTION_REG  __REG(0x7F00B00C)
#define SLAVE1_SLECTION_REG  __REG(0x7F00C00C)

#define SPI0_INT_EN_REG      __REG(0x7F00B010)
#define SPI1_INT_EN_REG      __REG(0x7F00C010)

#define SPI0_STATUS_REG      __REG(0x7F00B014)
#define SPI1_STATUS_REG      __REG(0x7F00C014)

#define SPI0_TX_DATA_REG      __REG(0x7F00B018)
#define SPI1_TX_DATA_REG      __REG(0x7F00C018)

#define SPI0_RX_DATA_REG      __REG(0x7F00B01C)
#define SPI1_RX_DATA_REG      __REG(0x7F00C01C)

#define Packet0_Count_REG      __REG(0x7F00B020)
#define Packet1_Count_REG      __REG(0x7F00C020)

#define SWAP0_CFG_REG      __REG(0x7F00B028)
#define SWAP1_CFG_REG      __REG(0x7F00C028)

#define FB0_Clk_Sel_REG      __REG(0x7F00B02C)
#define FB1_Clk_Sel_REG      __REG(0x7F00C02C)
