...
#define VIC0INTENABLE_REG	 (*(unsigned long volatile *)0x71200010)  
#define VIC0INTSELECT_REG	 (*(unsigned long volatile *)0x7120000C)  
#define VIC0VECTADDR_REG	  (*(unsigned long volatile *)0x71200100)  
#define VIC0IRQSTATUS_REG	 (*(unsigned long volatile *)0x71200000)  
#define VIC0ADDRESS_REG 		(*(unsigned long volatile *)0x71200F00)  
#define VIC0SOFTINT_REG 		 (*(unsigned long volatile *)0x71200018)  
#define VIC1ADDRESS_REG			 (*(unsigned long volatile *)0x71300F00)  
#define VIC0INTENCLEAR_REG		 (*(unsigned long volatile *)0x71200014)  
// extern interrupt  
#define EINT0CON0_REG 			(*(unsigned long volatile *)0x7F008900)  
#define EINT0MASK_REG			 (*(unsigned long volatile *)0x7F008920)  
#define EINT0PEND_REG 			(*(unsigned long volatile *)0x7F008924)  
#define EINT0FLTCON0_REG 		(*(unsigned long volatile *)0x7F008910) 
